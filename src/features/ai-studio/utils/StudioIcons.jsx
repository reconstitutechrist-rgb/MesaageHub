/**
 * SVG Icons for AI Studio
 *
 * Extracted from PhoneDashboardPage.jsx for reuse across components.
 * These are icon factory functions, not React components, so react-refresh warning is expected.
 */
...
export const StudioIcons = {
  ...
  multiPlatform: (color = '#fff', size = 24) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  palette: (color = '#fff', size = 24) => (
    ...
    >
      ...
      <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.9 0 1.8-.1 2.6-.4.5-.2.4-1-.2-1.2-.5-.2-.8-.7-.8-1.2 0-1.3 1.6-2.2 2.8-1.4.6.4 1.4.6 2.2.6 2.8 0 5.4-2.5 5.4-6 0-5-4.5-9.4-10-10z" />
    </svg>
  ),
  ...
  contrast: (color = '#fff', size = 24) => (
    ...
    >
      <circle cx="12" cy="12" r="10" />
      <path d="M12 2v20" />
      <path d="M12 2a10 10 0 0 1 0 20" fill={color} />
    </svg>
  ),

  sunset: (color = '#fff', size = 24) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  abTesting: (color = '#fff', size = 24) => (
    ...
    >
      ...
      <text x="7" y="14" fill={color} fontSize="8" fontWeight="bold" textAnchor="middle">
        A
      </text>
      <text x="17" y="14" fill={color} fontSize="8" fontWeight="bold" textAnchor="middle">
        B
      </text>
    </svg>
  ),
